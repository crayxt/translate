...
from core.formats import FileKind, detect_file_kind, load_po, load_resx, load_strings, load_ts, load_txt
...
def configure_parser(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("file", help="Input source file or local extraction JSON file")
